...
...%'world',vr.currentWorld,... % FOR NOW ASSUMING THAT WORLD IS "TYPE". I don't really see any major disadvantage to this at the moment (except that loading the world is time intensive)
    ...
    'startPosition', [0 0 eval(vr.exper.variables.animalElevation) pi/2],... % position vector [X Y Z theta] defining where the mouse started the trial
...
%     set(vr.ao,'samplerate',10000);
    ...
    vr.finalPathname = 'D:\Zuohan\virmenLogs';
    vr.pathname = 'D:\Zuohan\testlogs';
